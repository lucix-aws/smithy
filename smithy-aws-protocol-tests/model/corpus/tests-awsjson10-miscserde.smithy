...
apply EndpointHostPrefix @httpRequestTests([
    {
        ...
        headers: {
            ...
            "X-Amz-Target": "AwsJson10CorpusTests.EndpointHostPrefix",
        },
    },
])
...
apply EndpointHostLabel @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.EndpointHostLabel",
        },
        params: {
            label: "bar",
        }
...
apply IdempotencyTokenOp @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.IdempotencyTokenOp",
        },
        appliesTo: "client",
    },
    {
