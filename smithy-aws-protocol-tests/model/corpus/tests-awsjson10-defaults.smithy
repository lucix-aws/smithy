...
apply DefaultScalars @httpRequestTests([
    {
        ...
        headers: {
            ...
            "X-Amz-Target": "AwsJson10CorpusTests.DefaultScalars",
        },
        appliesTo: "client",
        params: {
...
apply DefaultCollections @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.DefaultCollections",
        },
        appliesTo: "client",
        params: {
            defaultList: [],
...
apply NestedDefaults @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.NestedDefaults",
        },
        params: {
            topLevel: {
                nested: {
...
apply RequiredMembers @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.RequiredMembers",
        },
        params: {
            requiredString: "hello",
            requiredInteger: 42,
...
apply ClientOptionalDefaults @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.ClientOptionalDefaults",
        },
        appliesTo: "client",
        params: {}
    },
