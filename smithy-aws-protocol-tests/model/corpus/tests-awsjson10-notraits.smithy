...
apply NoTraitScalarMembers @httpRequestTests([
    {
        ...
        headers: {
            ...
            "X-Amz-Target": "AwsJson10CorpusTests.NoTraitScalarMembers",
        },
        params: {
            booleanMember: true,
            byteMember: 7,
...
apply NoTraitStructOfScalars @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.NoTraitStructOfScalars",
        },
        params: {
            nested: {
                stringMember: "nestedNoTraits",
...
apply NoTraitListOfScalars @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.NoTraitListOfScalars",
        },
        params: {
            strings: ["alpha", "beta"],
            integers: [11, 22],
...
apply NoTraitMapOfScalars @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.NoTraitMapOfScalars",
        },
        params: {
            strings: {
                stringKeyOne: "gamma",
...
apply NoTraitUnionMembers @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.NoTraitUnionMembers",
        },
        params: {
            value: {
                stringMember: "unionString",
