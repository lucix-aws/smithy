...
apply EndpointHostPrefix @httpRequestTests([
    {
        id: "AwsJson10EndpointHostPrefix"
        documentation: """
        ...
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.EndpointHostPrefix" }
    }
])
...
apply EndpointHostLabel @httpRequestTests([
    {
        ...
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.EndpointHostLabel" }
        params: { label: "bar" }
    }
])
...
apply IdempotencyTokenOp @httpRequestTests([
    {
        id: "AwsJson10IdempotencyTokenAutoFill"
        ...
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.IdempotencyTokenOp" }
        appliesTo: "client"
    }
    {
        id: "AwsJson10IdempotencyTokenProvided"
...
apply RequestCompressionOp @httpRequestTests([
    {
        id: "AwsJson10RequestCompressionGzip"
        ...
        headers: {
            ...
            "X-Amz-Target": "AwsJson10CorpusTests.RequestCompressionOp"
