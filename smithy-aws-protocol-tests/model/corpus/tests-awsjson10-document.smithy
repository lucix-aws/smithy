...
apply DocumentMembers @httpRequestTests([
    {
        ...
        headers: {
            ...
            "X-Amz-Target": "AwsJson10CorpusTests.DocumentMembers",
        },
        params: {
            documentValue: { key: "value" },
        }
...
apply ListOfDocuments @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.ListOfDocuments",
        },
        params: {
            values: [42, "hello", true, [1, 2], { key: "value" }],
        }
...
apply MapOfDocuments @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.MapOfDocuments",
        },
        params: {
            values: {
                num: 42,
...
apply DocumentUnion @httpRequestTests([
    {
        ...
        headers: {
            "Content-Type": "application/x-amz-json-1.0",
            "X-Amz-Target": "AwsJson10CorpusTests.DocumentUnion",
        },
        params: {
            value: {
                documentValue: { nested: "object", count: 5 },
