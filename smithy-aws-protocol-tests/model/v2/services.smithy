...
service AwsJson11CorpusTests with [
    CoreProtocolTestService
    DefaultsProtocolTestService
    DocumentProtocolTestService
    EventStreamProtocolTestService
...
service RestJson1CorpusTests with [
    ...
    NoProtocolTraitsBehaviorService
    MiscSerdeTraitProtocolTestService
    ValidationProtocolTestService
] {}

@restXml
service RestXmlCorpusTests with [
    HttpBindingProtocolTestService
    DefaultsProtocolTestService
    XmlTraitsProtocolTestService
    EventStreamProtocolTestService
    HttpErrorProtocolTestService
    NoProtocolTraitsBehaviorService
    MiscSerdeTraitProtocolTestService
...
@ec2Query
@xmlNamespace(uri: "https://corpus.example.com/")
service Ec2QueryCorpusTests with [
    CoreProtocolTestService
    DefaultsProtocolTestService
    XmlTraitsProtocolTestService
    NoProtocolTraitsBehaviorService
