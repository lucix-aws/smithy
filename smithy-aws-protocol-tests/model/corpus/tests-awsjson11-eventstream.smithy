...
apply EventStreamResponse @eventStreamTests([
    ...
    {
        id: "AwsJson11EventStreamResponseMultipleEvents"
        documentation: """
...
apply EventStreamError @eventStreamTests([
    ...
    {
        id: "AwsJson11EventStreamErrorAfterMessage"
        documentation: """
    ...
    {
        id: "AwsJson11EventStreamErrorUnmodeled"
        documentation: """
...
apply EventStreamRequest @eventStreamTests([
    ...
    {
        id: "AwsJson11EventStreamRequestMultipleEvents"
        documentation: """
