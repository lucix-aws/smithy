...
structure ScalarMembersInputOutput {
    ...
    @ec2QueryName("ec2StringEnum")
    stringEnum: CorpusStringEnum

    @jsonName("jsonIntEnum")
    @xmlName("xmlIntEnum")
    @ec2QueryName("ec2IntEnum")
...
structure ListOfScalarsInputOutput {
    @jsonName("jsonBooleans")
    @xmlName("xmlBooleans")
    @ec2QueryName("ec2Booleans")
    booleans: BooleanList

    @jsonName("jsonBytes")
    @xmlName("xmlBytes")
    @ec2QueryName("ec2Bytes")
    bytes: ByteList

    @jsonName("jsonShorts")
    @xmlName("xmlShorts")
    @ec2QueryName("ec2Shorts")
    shorts: ShortList

    @jsonName("jsonIntegers")
    @xmlName("xmlIntegers")
    @ec2QueryName("ec2Integers")
    integers: IntegerList

    @jsonName("jsonLongs")
    @xmlName("xmlLongs")
    @ec2QueryName("ec2Longs")
    longs: LongList

    @jsonName("jsonFloats")
    @xmlName("xmlFloats")
    @ec2QueryName("ec2Floats")
    floats: FloatList

    @jsonName("jsonDoubles")
    @xmlName("xmlDoubles")
    @ec2QueryName("ec2Doubles")
    doubles: DoubleList

    @jsonName("jsonBigIntegers")
    @xmlName("xmlBigIntegers")
    @ec2QueryName("ec2BigIntegers")
    bigIntegers: BigIntegerList

    @jsonName("jsonBigDecimals")
    @xmlName("xmlBigDecimals")
    @ec2QueryName("ec2BigDecimals")
    bigDecimals: BigDecimalList

    @jsonName("jsonStrings")
    @xmlName("xmlStrings")
    @ec2QueryName("ec2Strings")
    strings: StringList

    @jsonName("jsonBlobs")
    @xmlName("xmlBlobs")
    @ec2QueryName("ec2Blobs")
    blobs: BlobList

    @jsonName("jsonTimestamps")
    @xmlName("xmlTimestamps")
    @ec2QueryName("ec2Timestamps")
    timestamps: TimestampList

    @jsonName("jsonEnums")
    @xmlName("xmlEnums")
    @ec2QueryName("ec2Enums")
    enums: CorpusStringEnumList

    @jsonName("jsonIntEnums")
    @xmlName("xmlIntEnums")
    @ec2QueryName("ec2IntEnums")
...
union CorpusUnion {
    @jsonName("jsonBooleanValue")
    @xmlName("xmlBooleanValue")
    booleanValue: Boolean

    @jsonName("jsonByteValue")
    @xmlName("xmlByteValue")
    byteValue: Byte

    @jsonName("jsonShortValue")
    @xmlName("xmlShortValue")
    shortValue: Short
    ...
    @jsonName("jsonLongValue")
    @xmlName("xmlLongValue")
    longValue: Long

    @jsonName("jsonFloatValue")
    @xmlName("xmlFloatValue")
    floatValue: Float

    @jsonName("jsonDoubleValue")
    @xmlName("xmlDoubleValue")
    doubleValue: Double

    @jsonName("jsonBigIntegerValue")
    @xmlName("xmlBigIntegerValue")
    bigIntegerValue: BigInteger

    @jsonName("jsonBigDecimalValue")
    @xmlName("xmlBigDecimalValue")
    ...
    @jsonName("jsonIntEnumValue")
    @xmlName("xmlIntEnumValue")
    intEnumValue: CorpusIntEnum

    @jsonName("jsonListValue")
    @xmlName("xmlListValue")
    listValue: StringList

    @jsonName("jsonMapValue")
    @xmlName("xmlMapValue")
    mapValue: StringMap

    @jsonName("jsonStructValue")
    @xmlName("xmlStructValue")
    structValue: SimpleStruct

    @jsonName("jsonUnionValue")
    @xmlName("xmlUnionValue")
...
structure RecursiveStructShape {
    ...
    @jsonName("jsonRecursiveMember")
    @xmlName("xmlRecursiveMember")
    @ec2QueryName("ec2RecursiveMember")
    recursiveMember: RecursiveStructShape

    @jsonName("jsonRecursiveList")
    @xmlName("xmlRecursiveList")
    @ec2QueryName("ec2RecursiveList")
    recursiveList: RecursiveStructList

    @jsonName("jsonRecursiveMap")
    @xmlName("xmlRecursiveMap")
    @ec2QueryName("ec2RecursiveMap")
...
union RecursiveUnionShape {
    ...
    @jsonName("jsonRecursiveValue")
    @xmlName("xmlRecursiveValue")
...
structure ComplexError {
    ...
    @jsonName("jsonCode")
    @xmlName("xmlCode")
    @ec2QueryName("ec2Code")
    code: Integer

    @jsonName("jsonNested")
    @xmlName("xmlNested")
    @ec2QueryName("ec2Nested")
