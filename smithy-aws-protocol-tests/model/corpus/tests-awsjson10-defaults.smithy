...
apply DefaultScalars @httpRequestTests([
    {
        id: "AwsJson10DefaultScalarsOmitsDefaults"
        ...
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.DefaultScalars" }
        appliesTo: "client"
        params: {}
    }
    {
        id: "AwsJson10DefaultScalarsSerializeNonDefaults"
...
apply DefaultScalars @httpResponseTests([
    {
        id: "AwsJson10DefaultScalarsPopulatesDefaultsOnDeserialize"
...
apply DefaultCollections @httpRequestTests([
    {
        id: "AwsJson10DefaultCollectionsOmitsEmptyDefaults"
        tags: ["top-level-default-omission"]
        documentation: """
        ...
        body: """
            {}"""
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.DefaultCollections" }
        appliesTo: "client"
        params: {}
    }
    {
        id: "AwsJson10DefaultCollectionsSerializeNonEmpty"
        tags: ["explicit-over-default"]
...
apply NestedDefaults @httpRequestTests([
    {
        id: "AwsJson10NestedDefaultsSerialize"
        ...
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.NestedDefaults" }
        params: {
            topLevel: {
                nested: {
                    greeting: "hello"
...
apply NestedDefaults @httpResponseTests([
    {
        id: "AwsJson10NestedDefaultsDeserializePopulatesDefaults"
...
apply RequiredMembers @httpRequestTests([
    {
        id: "AwsJson10RequiredMembersSerialize"
        ...
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.RequiredMembers" }
        params: {
            requiredString: "hello"
            requiredInteger: 42
            requiredBoolean: true
...
apply RequiredMembers @httpResponseTests([
    {
        id: "AwsJson10RequiredMembersDeserializeZeroValues"
    ...
    {
        id: "AwsJson10RequiredMembersDeserializeDefaults"
        tags: ["error-correction"]
...
apply NullSparseMembers @httpRequestTests([
    {
        id: "AwsJson10NullSparseMembersSerialize"
        ...
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.NullSparseMembers" }
        params: {
            sparseStringList: [null, "hello", null, "world", null]
            sparseStringMap: { key1: null, key2: "value", key3: "value2" }
            sparseStructList: [
...
apply NullSparseMembers @httpResponseTests([
    {
        id: "AwsJson10NullSparseMembersDeserialize"
...
apply ClientOptionalDefaults @httpRequestTests([
    {
        id: "AwsJson10ClientOptionalDefaultsNotPopulated"
        ...
        body: """
            {}"""
        bodyMediaType: "application/json"
        headers: { "Content-Type": "application/x-amz-json-1.0", "X-Amz-Target": "AwsJson10CorpusTests.ClientOptionalDefaults" }
        appliesTo: "client"
        params: {}
    }
])
